...
<div class="container" style="margin-bottom:30px;">
     ...
     <form name="paylaterform" action = "<?php echo base_url(); ?>events/create_order1" method = "post">
	...
	<input type="hidden" name="event_id" id ="event_id" value="<?php echo $events_cart[0]->event_id;?>">
       <input type="hidden" name="event_register_id" id ="event_register_id" value="<?php echo $events_cart[0]->event_register_id;?>">
