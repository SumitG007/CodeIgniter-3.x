...
<body> 
  <div style="float:none; margin:0 auto;width:600px;">
    	...
    	<div style="float:left;background: #f6f6f6; padding:10px; width:100%;">
            ...
            <h1 style="font-size:16px; color:orange; margin:5px 0px;">Please find below your login credentials. </h1>
            <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;">Please find below your login information to be used on BOMA website.</p>
            <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;"><strong>Email : </strong><?php echo $email; ?></p>
            ...
            <a href="http://boma.mydatavault.ca/members/login/">Member Login</a></p>
            
            <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;">If you have any question please contact us on <a href="mailto:customerservice@boma.ca" style="color:#8cc63e; text-decoration:none;" target="_blank"> customerservice@boma.ca</a></p>
