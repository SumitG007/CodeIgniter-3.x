           ...
           <div class="page-header">
            ...
            <div class="row" style="margin-top:10px; margin-bottom:30px;">
                ...
                <div class="col-md-10 col-sm-12">
                      ...
                      <form name="frmmember" method="post" action="<?php echo base_url(); ?>members/save_post_jobs" >
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          <label for="inputEmail" >Email Address *</label>
                            ...
                            <?php /*?><?php if(form_error('txtemail')){ echo "<span style='color:red; font-size:12px;'>Please enter valid email address.</span>"; } ?><?php */?>
                        </div>
                        <div class="form-group">
                       ...
                       <?php /* ?> <div class="form-group">
                          <label for="inputEmail" >Contact Name *</label>
                            ...
                            <?php if(form_error('txtcontact')){ echo "<span style='color:red; font-size:12px;'>Please enter your contact name.</span>"; } ?>
                        </div><?php */?>
                        ...
                        <div class="form-group">
                          <label for="inputEmail" >Phone Number *</label>
                            ...
                            <?php if(form_error('txtcontact')){ echo "<span style='color:red; font-size:12px;'>Please enter your phone number.</span>"; } ?>
                        </div>
                      ...
                      <div class="col-md-6 col-sm-12">
                          ...
                          <label for="inputAddress" >Job Description *</label>
                            ...
                            <?php echo display_ckeditor($ckeditor); if(form_error('txtjob_details')){ echo "<span style='color:red; font-size:12px;'>Please enter your job description.</span>"; } ?>
                         </div>
                        </fieldset>
                      </div>
