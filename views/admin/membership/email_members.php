...
<body> 
  <div style="float:none; margin:0 auto;width:600px;">
    	...
    	<div style="float:left;background: #f6f6f6; padding:10px; width:100%;">
            ...
            <h1 style="font-size:16px; color:orange; margin:5px 0px;">We are glad to inform you that your payment of $600.00 has been recevied. We acknowledge your payment made through check.</h1>
           ...
           <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;"><strong>Username : </strong><?php echo $user_email; ?></p>
