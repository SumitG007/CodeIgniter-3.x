<div class="content-wrapper">
        ...
        <!-- Main content -->
          ...
          <!-- /.row -->
          <form role="form" method="post" action="<?php echo base_url(); ?>admin/jobs/update_member_approved_jobs">
          <div class="row">
              ...
              <div class="box-header">
                  <h3 class="box-title">Edit Approved Jobs</h3>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="job_name" value="<?php echo $viewdata[0]->job_name; ?>"/>
                      <?php if(form_error('job_name') != ''){ ?><div class="alert-danger"><?php echo form_error('job_name'); ?></div><?php } ?>
                    </div>
                     <input type="hidden" name="id" value="<?php echo $viewdata[0]->jid; ?>" />
                    
                    <div class="form-group">
                      <label>Start Date</label>
                       <div class="form-group">
                                <div class='input-group date' id='datetimepicker1'>
                                    <input type='text' name="start_date" id="start_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($viewdata[0]->start_date)); ?>" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                                <div class='input-group date' id='datetimepicker2'>
                                    <input type='text' name="end_date" id="end_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($viewdata[0]->end_date)); ?>" />
                    ...
                    <?php /*?><div class="form-group">
                      <label>Timings  *</label>
                      <input type="text" name="timing"  class="form-control" value="<?php echo $viewdata[0]->start_time." - ".$viewdata[0]->end_time; ?>" readonly="readonly"/>
                    </div><?php */?>
                    <div class="form-group">
                      <label>Email *</label>
                      <input type="text" name="email" class="form-control" value="<?php echo $viewdata[0]->email; ?>"/>
                   ...
                   <div class="form-group">
                          <label for="inputEmail" >Company Name *</label>
                            <input class="form-control" id="inputEmail" name="company_name"  type="text" value="<?php echo $viewdata[0]->company_name; ?>">
                        ...
                        <div class="form-group">
                          <label for="inputEmail" >Address *</label>
                            <input class="form-control" id="inputEmail" name="address"  type="text" value="<?php echo $viewdata[0]->address; ?>">
                         ...
                         <div class="form-group">
                          <label for="inputEmail" >Contact Name *</label>
                            <input class="form-control" id="inputEmail" name="name"  type="text" value="<?php echo $viewdata[0]->name; ?>">
                           <?php /*?> <?php if(form_error('name')){ echo "<span style='color:red; font-size:12px;'>Please enter your contact name.</span>"; } ?><?php */?>
                      </div>
                    <div class="form-group">
                      <label>Phone Number *</label>
                      <input type="text" name="contact" class="form-control" value="<?php echo $viewdata[0]->contact; ?>" />
              ...
              <div class="box-header">
                  <h3 class="box-title">Business References</h3>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="job_details" rows="23" value=""><?php echo $viewdata[0]->job_details; ?></textarea>
