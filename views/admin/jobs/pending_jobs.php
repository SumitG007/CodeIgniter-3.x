<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1> Company Representative Pending Job Applications</h1>
          <ol class="breadcrumb">
                ...
                <form action="<?php echo base_url(); ?>admin/menu/sort_order/" method="post">
                 <table class="table table-hover">
                    ...
                    <tr>
					  ...
					  <th><a href="<?php echo base_url(); ?>admin/jobs/enable/<?php echo $item->jid; ?>/"><span class="label label-success">Approve Job ?</span></a>
                      &nbsp;<a href="<?php echo base_url(); ?>admin/jobs/edit_member_pending_jobs/<?php echo $item->jid; ?>"><span class="label label-warning">Edit</span></a>
                      &nbsp;<a href="<?php echo base_url(); ?>admin/jobs/del_jobs/<?php echo $item->jid; ?>/pending" onClick="return confirm('Are you sure you want to delete?')"><span class="label label-danger">Delete</span></a></th>  
