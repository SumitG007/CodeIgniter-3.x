...
<body> 
  <div style="float:none; margin:0 auto;width:600px;">
    	...
    	<div style="float:left;background: #f6f6f6; padding:10px; width:100%;">
            ...
            <?php /*?><h1 style="font-size:16px; color:orange; margin:5px 0px;">your job is posted. <strong><?php //echo $fees; ?></strong></h1><?php */?>
            <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;">We are pleased to inform you that your payment has been received. Further to that action, we have activated your job posted on our website.<br/> Should there be any other query please do let us know. Your job listing will be automatically get deleted after the closing date </p>
            
            <p style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#505050;">Should you have any other query please do not hesitate to contact us.</p>
