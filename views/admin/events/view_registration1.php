                ...
                <?php 
                  ...
                  <h3 class="box-title"><?php echo $events[0]->order_eventname; ?></h3>
                   <?php
                    ...
                    <?php /*?> <a href="<?php echo base_url(); ?>admin/events/add_events_sub_member/<?php if(count($event_id) >0 ) { echo $event_id; } ?>"> <button class="btn btn-block btn-primary btn-sm">Add New Sub Member</button></a><?php */?>
					...
					/* foreach( $submember_name as $row)
					 ...
					 ?></td>
                      ...
                      <!--<td>-->
                              ...
                              <?php /*?>  <a href="<?php echo base_url(); ?>admin/events/view_sub_member_list/<?php echo $item->event_id; ?>/<?php echo $item->user_id; ?>/<?php echo $item->event_register_id; ?>"><span class="label label-danger">delete</span></a>	
                        </td>     <?php */?>  		
