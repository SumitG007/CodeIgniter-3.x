...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>admin/posts">Home Board</a></li>
            <li class="active">Add New Blog Post</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url()."admin/posts/addbanner"; ?>"  enctype="multipart/form-data" onSubmit="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <!--select type="text" class="form-control" name="status" value="<?php echo set_value('subtitle')?>" /!-->
                      <?php echo form_dropdown('tags[]',$tags,null,array('class' => 'form-control','multiple'=>true));?>
                    </div>              
                  </div><!-- /.box-body -->
