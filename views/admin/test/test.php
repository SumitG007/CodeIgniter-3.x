          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url()."admin/test/addrecord"; ?>"  enctype="multipart/form-data" onSubmit="return check()">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="userfile1" id="userfile1" size="20"  class="form-control" />
                      <span class="btn btn-danger btn-xs">[ * Image size must be - width: 1700px, height:1100px   ]</span>
					  <?php if($error){ ?><div class="btn btn-danger btn-xs"><?php echo $error;?></div><?php } ?>
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputFile">Upload Image2</label>
                      <input type="file" name="userfile2" id="userfile2" size="20"  class="form-control" />
                      <span class="btn btn-danger btn-xs">[ * Image size must be - width: 1700px, height:1100px   ]</span>
					  <?php if($error){ ?><div class="btn btn-danger btn-xs"><?php echo $error;?></div><?php } ?>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="userfile3" id="userfile3" size="20"  class="form-control" />
                      <span class="btn btn-danger btn-xs">[ * Image size must be - width: 1700px, height:1100px   ]</span>
					  <?php if($error){ ?><div class="btn btn-danger btn-xs"><?php echo $error;?></div><?php } ?>
                    </div>              
                  </div><!-- /.box-body -->
